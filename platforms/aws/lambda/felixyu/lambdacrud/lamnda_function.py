...
def lambda_handler(event, context):
    ...
    if httpMethod == getMethod and path == healthPath:
        ...
        resposne = saveProduct(json.loads(event['body']))
        ...
        resposne = buildResponse(404, 'Not Found')
...
def getProducts():
    try:
        ...
        # Loop used to ensure that last item received is actual last item vs last in segment
        ...
        logger.exception("Error gettting products")
